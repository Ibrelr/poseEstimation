#!/usr/bin/env python3
"""
Pose Estimation with Hand Tracking Demo
=======================================

A demo script that combines pose estimation with hand tracking
for precise detection of fingers and hand joints.
"""
...
def main():
    """Main demo function."""
    parser = argparse.ArgumentParser(description='Pose Estimation with Hand Tracking Demo')
    ...
    # Initialize MediaPipe Hands for precise hand tracking
    ...
    print("Pose Estimation with Hand Tracking Demo")
    print("Press 'q' to quit, 's' to save screenshot, 'f' to toggle fullscreen")
    print("This version tracks BOTH pose AND hands with precise finger detection!")
    
    # Create window
    window_name = 'Pose + Hand Tracking Demo'
    ...
    while True:
        ...
        # Draw hand landmarks with precise finger tracking
        ...
        if key == ord('q'):
            ...
            filename = f"pose_hands_demo_{timestamp}.jpg"
